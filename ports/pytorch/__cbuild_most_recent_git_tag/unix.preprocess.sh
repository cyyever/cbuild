...
${sed_cmd} -i -e "/INTEL_MKL_DIR/s/,/,'USE_MKLDNN', 'CUDA_USE_STATIC_CUDA_RUNTIME', 'USE_STATIC_MKL', 'CAFFE2_USE_MKL','USE_NCCL','CMAKE_CXX_STANDARD',/" tools/setup_helpers/cmake.py
...
${sed_cmd} -i -e '/lintrunner/d' requirements.txt
