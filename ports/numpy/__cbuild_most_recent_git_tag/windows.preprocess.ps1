...
(Get-Content numpy/distutils/misc_util.py) -Replace 'os.add_dll_directory\(extra_dll_dir\)', "os.add_dll_directory(extra_dll_dir);os.add_dll_directory('${env:INSTALL_PREFIX}/lib');os.add_dll_directory('${env:INSTALL_PREFIX}/bin');os.add_dll_directory('${ProgramFiles(x86)}/Intel/oneAPI/compiler/latest/windows/redist/intel64_win/compiler')" | Set-Content  numpy/distutils/misc_util.py
